...
import "./chunks/astro-designed-error-pages_DVXiAYgq.mjs";
import "cookie";
import { s as sequence } from "./chunks/index_G1_zElnN.mjs";
...
const onRequest$1 = clerkMiddleware((auth, context, next) => {
  if (isProtectedRoute(context.request)) {
    ...
    const allowedUsers = allowedUsersStr.split(",").map((s) => s.trim());
